...
![Slack 리포트 - 삼성전자](docs/screenshots/slack_samsung.png)
![Slack 리포트 - NVDA](docs/screenshots/slack_nvda.png)

> 스크린샷은 `docs/screenshots/` 폴더에 추가해 주세요.
...
💡 분할 매수 후 HBM 수주 확인 시 비중 확대 | Generated by Claude Investment Agent
```
